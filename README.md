...
**2026年8月5号 至 2026年 8月31号 商业版代码更新内容**

718、修复部分手机上启动APP后按返回键无反应<br/>
717、处理fake_dlopen,解决某些函数无法找到的问题<br/>
716、处理hook后的权限恢复<br/>
715、处理maps中的VMA，将某些被mprotect拆分的合并<br/>
714、修复LocaleManager中的函数名错误<br/>

**2026年7月17号 至 2026年 8月4号 商业版代码更新内容**

713、对sdcard安装的文件进行了系统APP模拟<br/>
712、修复getOatFile()函数<br/>
711、路径模拟相关的配置调整<br/>
710、执行execve时增加对LD_LIBBRAY_PATH的支持<br/>
709、修复多个不同类型的与加固/检测相关的导致APP无法启动的问题<br/>


<details>
<summary>2017年 12月 至 2026年 7 月 16 日 商业版代码更新内容(下拉打开)</summary>  <br/>

**2026年7月7号 至 2026年 7月16号 商业版代码更新内容**

708、修复某些c函数指令较短hook后导致后面的指令被覆盖<br/>
707、调整ext插件的进程号，避免p0进程过早启动导致未初始化完全<br/>
706、让插件进程也支持生成和加载binder stub dex<br/>



**2026年6月22号 至 2026年 7月6号 商业版代码更新内容**

705、适配17.0 beta5上的IJobCallback<br/>
704、适配17.0上startService API增加了包名检测<br/>
703、增加对AccessibilityManager API的适配<br/>
702、更新 HiddenApiBypass<br/>

**2026年6月4号 至 2026年 6月21号 商业版代码更新内容**

701、修复Parcel解析时候的long与int解析错误<br/>
700、修复启动JobService时acore进程容易出现ANR<br/>
699、适配IRoleManager API<br/>
698、更新依赖项<br/>
697、修升级AGP到9.2.1<br/>
696、对UI适配无边框<br/>
695、修复17.0上遇到的反射错误<br/>
694、修复target sdk升级到37后遇到的KeepAliveService崩溃<br/>


**2026年5月22号 至 2026年 6月3号 商业版代码更新内容**

693、将maps文件调整为按行处理,避免bad alloc<br/>
692、对部分抗检测的调整<br/>
691、增加对某些加固的支持<br/>
690、处理有些加固APP的进程在部分设备上无法kill进程<br/>
689、修复baidu app在某些手机上无法打开 <br/>
688、适配某些加固导致的内存错误<br/>
687、针对一些特征检测的处理<br/>

**2026年5月7号 至 2026年 5月21号 商业版代码更新内容**

686、增加对proc文件系统的更多特征处理，包括inline hook&seccomp-bpf模式<br/>
685、对访问父进程的proc也增加处理<br/>
684、适配17.0上ShortcutServiceStub API <br/>
683、修复appendFrom的时候crash,使用setDataSize()来清空所有数据 <br/>
682、修复baidu app在某些手机上无法打开 <br/>
681、修复Unable to instantiate service <br/>
680、修复有些APP因为请求不到android.permission.READ_PHONE_NUMBERS提示:"已禁用该权限，请手动打开该权限"<br/>
679、修复包名错误 <br/>
678、适配特定app提示环境异常 <br/>


**2026年4月16号 至 2026年 5月5号 商业版代码更新内容**

677、调整和简化seccomp-bpf配置代码,通过getSeccompBpfHookMode()控制hook范围 <br/>
676、修复seccomp-bpf调用CallTrustedSyscall后的重入问题 <br/>
675、修复有些加固后的APP执行su检测的时候提示设备已root <br/>
674、增加对/proc/self/pid/fd和/proc/pid/task/map_files的遍历处理 <br/>
673、对于使用fstat获取maps/status/cgroup等文件时转为获取真实文件信息 <br/>
672、增加功能配置功能:可以将VA自身日志通过socket发往logd <br/>
671、修复通过google play安装后/data/data/app.v/virtual/data/app/com.xx.xx/split_config.arm64_v8a.apk is writeable导致无法加载问题 <br/>
670、适配IStatusBarService的相关API <br/>

**2026年4月1号 至 2026年 4月15号 商业版代码更新内容**

669、修复WifiManager中与AttributionSource相关的参数<br/>
668、修复seccomp-bpf crash的问题<br/>


**2026年3月17号 至 2026年 3月31号 商业版代码更新内容**

667、实现Contacts访问模拟<br/>
666、修复11.0+上getLastLocation()参数问题<br/>
665、修复canAuthenticate()无权限报错问题<br/>
664、增加对IStatusBarService处理<br/>
